...
let siteHeadlines = document.querySelectorAll('h2');
...
for (let i = 0; i < siteHeadlines.length; i++) {
  siteHeadlines[i].setAttribute('style', 'color: blue;font-size: 30px; font-weight: bold');
}
